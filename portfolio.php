   ...
   <div class="container <?php echo ( !empty($themetek_page_layout) ? 'fullwidth' : '' );?>" >
      ...
      <div class="row" id="portfolio-items">
         <?php
			        ...
			        $src = wp_get_attachment_image_src( get_post_thumbnail_id(get_the_ID()), 'kd-portfolio-image', false, '' );
         ?>
           ...
           <div class="portfolio-content" data-id="<?php get_the_ID(); ?>">
              <div class="portfolio-inner-content">
                  <h3><?php the_title(); ?></h3>
                  <a class="tt_button" href="<?php echo esc_url(get_permalink(get_the_ID())); ?>"><?php echo apply_filters( 'portfolio_readmore_text', esc_html__("Read more", "etalon") ); ?></a>
              </div>
           </div>
			</div>
      <?php endwhile; ?>
