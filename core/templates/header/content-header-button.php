<?php
    ...
    if ( isset($redux_ThemeTek['tek-header-button']) ) {
      ...
      <?php if ( isset( $redux_ThemeTek['tek-button-new-page'] ) && $redux_ThemeTek['tek-button-new-page'] != '' ) : ?>
         <a class="modal-menu-item menu-item" href="<?php echo esc_url( $redux_ThemeTek['tek-button-new-page'] ); ?>" <?php echo ( isset($redux_ThemeTek['tek-button-target'] ) &&  $redux_ThemeTek['tek-button-target'] == 'new-page') ? 'target="_blank"' : 'target="_self"'; ?>><?php echo esc_html($redux_ThemeTek['tek-header-button-text']);?></a>
      <?php endif; ?>
    <?php endif; ?>
<?php } ?>
